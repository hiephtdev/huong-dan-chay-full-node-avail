...
echo '=============== SETUP FINISHED ==================='
echo -e "View the logs from the running service, use: journalctl -f -u availd.service"
echo -e "Check if the node is running, enter: sudo systemctl status availd.service"
echo -e "Stop your Avail node, use: sudo systemctl stop availd.service"
echo -e "Start your Avail node, enter: sudo systemctl start availd.service"
echo -e "After modifying the availd.service file, reload the service using: sudo systemctl daemon-reload"
echo -e "Restart the service, use: sudo systemctl restart availd.service"